...
@section('title', __('labels.backend.access.instituts.management') . ' | ' . __('labels.backend.access.instituts.edit'))

@section('content')
{{ html()->modelForm($institut, 'PATCH', route('admin.auth.institut.update', $institut))->class('form-horizontal')->open() }}
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-sm-5">
                    <h4 class="card-title mb-0">
                        ...
                        <small class="text-muted">@lang('labels.backend.access.instituts.edit')</small>
                    </h4>
                </div><!--col-->
            </div><!--row-->
            <!--row-->
